...
Init <- function(sim) {
 ...
 # print("looking at studyAreatmp" )
 # print(studyAreaTmp)
  #print("looking at veg map init")
  #print(table(sim$vegMapInit[]))
 # print(sim$vegMapInit) 
...
.inputObjects <- function(sim){
 ...
 # if (!("ageMapInit" %in% sim$.userSuppliedObjNames)){
  if (!suppliedElsewhere("ageMapInit", sim)){ # The suppliedElsewhere() is the most appropriated to check existence of objects across modules.
