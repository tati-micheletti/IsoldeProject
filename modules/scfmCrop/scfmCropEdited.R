...
Init <- function(sim) {
  ...
  sim$studyArea <- shape[shape$ECODISTRIC==609,] #here you can choose the ecodistrict you wish to study
      vegProjection<-CRS("+proj=lcc +lat_1=49 +lat_2=77 +lat_0=0 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +units=m +no_defs")
...
.inputObjects <- function(sim){
  ...
  if (!("vegMapInit" %in% sim$.userSuppliedObjNames)){
    ...
    fp<-"C:/Users/RALAS6/Documents/Modelling Forest Landscapes Class/Labs/scfmModules/scfmCrop/data/vegMapInit/LCC2005_V1_4a.tif"    
